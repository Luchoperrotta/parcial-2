...
class MedicalCentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_center" do
    assert_difference('MedicalCenter.count') do
      post medical_centers_url, params: { medical_center: { address: @medical_center.address, appointment_id: @medical_center.appointment_id, description: @medical_center.description, medical_center_type_id: @medical_center.medical_center_type_id, name: @medical_center.name, phone: @medical_center.phone } }
    end
  ...
  test "should update medical_center" do
    patch medical_center_url(@medical_center), params: { medical_center: { address: @medical_center.address, appointment_id: @medical_center.appointment_id, description: @medical_center.description, medical_center_type_id: @medical_center.medical_center_type_id, name: @medical_center.name, phone: @medical_center.phone } }

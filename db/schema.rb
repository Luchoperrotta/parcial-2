...
ActiveRecord::Schema.define(version: 2021_06_14_214717) do

  create_table "appointments", force: :cascade do |t|
    t.datetime "appointments_date"
  ...
  create_table "has_workers", force: :cascade do |t|
    t.datetime "hasWorker_date"
    t.integer "medical_center_id", null: false
    t.integer "worker_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_center_id"], name: "index_has_workers_on_medical_center_id"
    t.index ["worker_id"], name: "index_has_workers_on_worker_id"
  end
  ...
  add_foreign_key "has_workers", "medical_centers"
